        ...
        <div style="background-image: url('{{ asset('bg-white.svg') }}')" class="w-full h-full bg-repeat bg-auto bg-center">
            <div class="bg-white/5 backdrop-blur-0">
                <div class="w-screen h-screen flex flex-row overflow-clip relative">
                    <div class="w-full h-screen p-2 bg-rose-50">
                        <div class="w-full h-full max-h-[100vh] text-base leading-normal font-mono text-rose-900 overflow-y-auto">
                            <div class="w-full h-full sm:flex flex-col justify-center items-center">
                                <div class="w-full sm:max-w-md h-fit p-2 flex flex-col space-x-0 space-y-2 bg-rose-100 rounded-lg">
