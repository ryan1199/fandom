<div class="w-full h-full flex flex-col space-x-0 space-y-4 {{ 'text-[' . $preferences['font_size'] . 'px]' }} {{ 'leading-[calc(' . $preferences['font_size'] . 'px*1.2)]' }} {{ 'font-[' . $preferences['selected_font_family'] . ']' }} {{ 'text-' . $preferences['color_2'] . '-900' }} select-none">
    <div class="w-full h-fit grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
