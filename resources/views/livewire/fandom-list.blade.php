                    ...
                    <div class="w-full h-fit max-h-[calc(100vh-50vh)] p-4 grid grid-cols-1 grid-rows-1 content-stretch overflow-clip bg-[{{ $preferences['color_primary'] }}]/10 backdrop-blur-sm border-0 border-transparent rounded-lg">
                        <div class="w-full h-full p-2 bg-[{{ $preferences['color_secondary'] }}] border-0 border-transparent rounded-lg">
                            <div wire:scroll class="w-full h-full max-h-[calc(100vh-50vh)] flex flex-col space-x-0 space-y-2 border-0 border-transparent rounded-lg overflow-y-auto">
                                ...
                                <div class="w-full h-full p-2 flex flex-row space-x-2 space-y-0 text-[{{ $preferences['color_text'] }}] text-center bg-[{{ $preferences['color_primary'] }}] border border-[{{ $preferences['color_secondary'] }}] rounded-lg">
                                    ...
                                    <a wire:navigate.hover href="{{ route('fandom-details', $fandom) }}" class="w-fit h-full py-2 flex flex-col space-x-0 space-y-1 justify-center items-center border-2 border-[{{ $preferences['color_secondary'] }}] rounded-lg cursor-pointer transition-all duration-100 hover:opacity-50 active:duration-75 active:scale-[.95]">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-4 h-4 bg-[{{ $preferences['color_primary'] }}]">
