<div class="w-full h-screen max-h-[100vh] {{ 'text-[' . $preferences['font_size'] . 'px]' }} {{ 'leading-[calc(' . $preferences['font_size'] . 'px*1.2)]' }} {{ 'font-[' . $preferences['selected_font_family'] . ']' }} {{ 'text-' . $preferences['color_2'] . '-900' }} select-none overflow-clip">
    <div class="w-full container h-screen max-h-[100vh] mx-auto flex flex-col lg:flex-row space-x-0 lg:space-x-2 space-y-2 lg:space-y-0 items-center lg:items-start overflow-clip">
        {{-- profile --}}
        <div class="w-full max-w-xl h-fit max-h-[50vh] lg:max-h-[100vh] lg:pb-14 p-2 overflow-y-auto">
        ...
        <div class="w-full max-w-xl lg:max-w-full h-fit max-h-[50vh] lg:max-h-[100vh] pb-14 p-2 break-inside-avoid-column overflow-y-auto">
