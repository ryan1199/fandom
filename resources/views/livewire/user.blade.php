<div
    ...
    <div class="container h-fit max-h-[calc(100%-48px)] overflow-clip">
        <div class="w-full h-fit">
            <div class="w-full h-fit max-h-[calc(100vh-96px)] grid grid-cols-3 grid-flow-row-dense auto-cols-max gap-4 overflow-clip">
                <div wire:scroll class="col-span-2 h-fit max-h-[calc(100vh-96px)] p-4 flex flex-col space-x-0 space-y-4 overflow-y-auto overflow-x-clip bg-[{{ $preferences['color_primary'] }}]/10 backdrop-blur-sm border-0 border-transparent rounded-lg">
                    <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-2 bg-[{{ $preferences['color_secondary'] }}] border-0 border-transparent rounded-lg">
                        <div class="bg-gradient-to-tr from-[{{ $preferences['color_1'] }}] via-[{{ $preferences['color_2'] }}] to-[{{ $preferences['color_3'] }}] relative rounded-lg">
                            @if ($user->cover !== null)
                            ...
                            @else
                                <div class="absolute top-0 bottom-0 right-0 left-0 m-auto w-40 h-40 bg-[{{ $preferences['color_primary'] }}] border-0 border-transparent rounded-full"></div>
                            @endif
                        </div>
                        <div class="w-full h-hit p-2 flex flex-col space-x-0 space-y-2 text-[{{ $preferences['color_text'] }}] text-center bg-[{{ $preferences['color_primary'] }}] border-0 border-transparent rounded-lg">
                    ...
                    <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-2 bg-[{{ $preferences['color_secondary'] }}] border-0 border-transparent rounded-lg">
                        <div class="w-full h-hit p-2 text-[{{ $preferences['color_text'] }}] text-center bg-[{{ $preferences['color_primary'] }}] border-0 border-transparent rounded-lg">
                            <h1>User activity</h1>
                ...
                <div wire:scroll class="h-fit max-h-[calc(100vh-96px)] p-4 overflow-y-auto overflow-x-clip bg-[{{ $preferences['color_primary'] }}]/10 backdrop-blur-sm border-0 border-transparent rounded-lg">
                    <div class="mb-2 p-2 bg-[{{ $preferences['color_secondary'] }}] border-0 border-transparent rounded-lg">
                        <div class="p-2 bg-[{{ $preferences['color_primary'] }}] border-0 border-transparent rounded-lg">
                            <h1 class="text-[{{ $preferences['color_text'] }}] text-center text-[calc({{'4px+' . $preferences['font_size'] . 'px' }})] font-semibold">Following</h1>
                        </div>
                    </div>
                    <div class="mb-2 p-2 bg-[{{ $preferences['color_secondary'] }}] border-0 border-transparent rounded-lg">
                        <div class="p-2 bg-[{{ $preferences['color_primary'] }}] border-0 border-transparent rounded-lg">
                            <h1 class="text-[{{ $preferences['color_text'] }}] text-center text-[calc({{'4px+' . $preferences['font_size'] . 'px' }})] font-semibold">Chat</h1>
                        </div>
                    </div>
                </div>
            </div>
