<div class="w-full h-fit flex flex-col space-x-0 space-y-2 border-0 border-transparent rounded-lg">
    ...
    @endif
    <form wire:submit="createFandom" class="w-full h-fit p-0 bg-[{{ $preferences['color_primary'] }}] border border-[{{ $preferences['color_secondary'] }}] rounded-lg">
