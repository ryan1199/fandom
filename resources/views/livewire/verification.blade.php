            ...
            <div wire:scroll
                ...
                <div
                    ...
                    <div class="bg-gradient-to-tr from-orange-500 via-pink-500 to-indigo-500 rounded-lg select-none">
                        <div style="background-image: url('{{ asset('verification-cover-black.svg') }}')"
                    ...
                    <form wire:submit="sendEmailVerification" method="post"
                        ...
                        <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-2 justify-center">
                            ...
                            <button type="submit"
                                class="w-full h-fit self-center p-2 text-base text-black bg-white border border-black rounded-lg select-none transition-all duration-100 hover:opacity-50 active:duration-75 active:scale-[.95]">Verification</button>
                        </div>
                    </form>
                </div>
            </div>
