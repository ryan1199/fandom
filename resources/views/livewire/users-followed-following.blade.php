<div class="w-full h-fit grid grid-cols-2 gap-2">
    <div class="w-full h-fit mb-1 p-2 flex flex-col space-x-0 space-y-1 items-center {{ 'bg-' . $preferences['color_2'] . '-50' }} border {{ 'border-' . $preferences['color_2'] . '-200' }} rounded-lg">
