    ...
    <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-2 {{ 'bg-[' . $preferences['color_secondary'] . ']' }} border-0 rounded-lg">
        ...
        <form wire:submit="updatePreference" class="w-full h-fit p-0 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} rounded-lg">
            <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-2 justify-center">
                <label for="color_1" class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <span class="w-full h-fit font-medium text-left select-none">Color 1</span>
                    <input wire:model="color_1" name="color_1" type="color" id="color_1" class="w-full h-10 form-input text-center align-middle p-2 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
                </label>
                <hr class="{{ 'border-[' . $preferences['color_secondary'] . ']' }}">
                <label for="color_2" class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <span class="w-full h-fit font-medium text-left select-none">Color 2</span>
                    <input wire:model="color_2" name="color_2" type="color" id="color_2" class="w-full h-10 form-input text-center align-middle p-2 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
                </label>
                <hr class="{{ 'border-[' . $preferences['color_secondary'] . ']' }}">
                <label for="color_3" class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <span class="w-full h-fit font-medium text-left select-none">Color 3</span>
                    <input wire:model="color_3" name="color_3" type="color" id="color_3" class="w-full h-10 form-input text-center align-middle p-2 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
                </label>
                <hr class="{{ 'border-[' . $preferences['color_secondary'] . ']' }}">
                <label for="color_primary" class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <span class="w-full h-fit font-medium text-left select-none">Color primary</span>
                    <input wire:model="color_primary" name="color_primary" type="color" id="color_primary" class="w-full h-10 form-input text-center align-middle p-2 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
                </label>
                <hr class="{{ 'border-[' . $preferences['color_secondary'] . ']' }}">
                <label for="color_secondary" class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <span class="w-full h-fit font-medium text-left select-none">Color secondary</span>
                    <input wire:model="color_secondary" name="color_secondary" type="color" id="color_secondary" class="w-full h-10 form-input text-center align-middle p-2 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
                </label>
                <hr class="{{ 'border-[' . $preferences['color_secondary'] . ']' }}">
                <label for="color_text" class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <span class="w-full h-fit font-medium text-left select-none">Color text</span>
                    <input wire:model="color_text" name="color_text" type="color" id="color_text" class="w-full h-10 form-input text-center align-middle p-2 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
                </label>
                <hr class="{{ 'border-[' . $preferences['color_secondary'] . ']' }}">
                <label for="font_size" class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <span class="w-full h-fit font-medium text-left select-none whitespace-nowrap">Font size</span>
                    <input wire:model="font_size" name="font_size" type="number" id="font_size" min="12" max="128" class="w-full h-10 form-input text-center align-middle p-2 {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} @error('cover') invalid @else valid @enderror rounded-lg">
                </label>
                <hr class="{{ 'border-[' . $preferences['color_secondary'] . ']' }}">
                <div class="grid grid-cols-2 gap-2 items-center {{ 'text-[' . $preferences['color_text'] . ']' }} {{ 'text-[' . $preferences['font_size'] . 'px]' }}">
                    <label for="fonts" class="w-full h-fit font-medium text-left select-none whitespace-nowrap">Font family</label>
                    <select wire:model="selected_font_family" name="selected_font_family" id="fonts" class="w-full h-10 form-select {{ 'bg-[' . $preferences['color_primary'] . ']' }} border {{ 'border-[' . $preferences['color_secondary'] . ']' }} rounded-lg cursor-pointer">
        ...
        <button type="submit" wire:click="resetPreference" wire:confirm="Are you sure you want to reset your preference settings?" class="w-full h-fit p-2 text-center {{ 'text-[' . $preferences['font_size'] . 'px]' }} text-black bg-red-500 border-0 rounded-lg cursor-pointer select-none transition-all duration-100 hover:opacity-50 active:duration-75 active:scale-[.95]">ResetPreference</button>
    </div>
</div>
@script
    <script>
        ...
        preferenceSettingsHeader.addEventListener('mouseup', mouseUp, false);
