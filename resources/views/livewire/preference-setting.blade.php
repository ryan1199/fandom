<div x-cloak x-show="preference_modal" x-transition.duration.500ms.scale.origin class="w-full h-fit mb-2 p-2 flex flex-col space-x-0 space-y-2 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_secondary'] }}] border-0 border-transparent rounded-lg">
    @if ($errors->any())
    ...
    <form wire:submit="updatePreference" class="w-full h-fit p-0 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{ session()->get(Auth::user()->username . '-preference')['color_secondary'] }}] rounded-lg">
        <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-2 justify-center">
            <label for="color_1" class="flex flex-col sm:flex-row space-x-0 space-y-2 sm:space-x-2 space- sm:space-y-0 justify-between items-stretch sm:items-center text-[{{ session()->get(Auth::user()->username . '-preference')['color_text'] }}] text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}]">
                ...
                <input wire:model="color_1" name="color_1" type="color" id="color_1" class="w-[5vw] h-[5vh] form-input text-center align-middle p-2 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{session()->get(Auth::user()->username . '-preference')['color_secondary']}}] @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
            </label>
            <label for="color_2" class="flex flex-col sm:flex-row space-x-0 space-y-2 sm:space-x-2 space- sm:space-y-0 justify-between items-stretch sm:items-center text-[{{ session()->get(Auth::user()->username . '-preference')['color_text'] }}] text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}]">
                ...
                <input wire:model="color_2" name="color_2" type="color" id="color_2" class="w-[5vw] h-[5vh] form-input text-center align-middle p-2 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{session()->get(Auth::user()->username . '-preference')['color_secondary']}}] @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
            </label>
            <label for="color_3" class="flex flex-col sm:flex-row space-x-0 space-y-2 sm:space-x-2 space- sm:space-y-0 justify-between items-stretch sm:items-center text-[{{ session()->get(Auth::user()->username . '-preference')['color_text'] }}] text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}]">
                ...
                <input wire:model="color_3" name="color_3" type="color" id="color_3" class="w-[5vw] h-[5vh] form-input text-center align-middle p-2 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{session()->get(Auth::user()->username . '-preference')['color_secondary']}}] @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
            </label>
            <label for="color_primary" class="flex flex-col sm:flex-row space-x-0 space-y-2 sm:space-x-2 space- sm:space-y-0 justify-between items-stretch sm:items-center text-[{{ session()->get(Auth::user()->username . '-preference')['color_text'] }}] text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}]">
                ...
                <input wire:model="color_primary" name="color_primary" type="color" id="color_primary" class="w-[5vw] h-[5vh] form-input text-center align-middle p-2 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{session()->get(Auth::user()->username . '-preference')['color_secondary']}}] @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
            </label>
            <label for="color_secondary" class="flex flex-col sm:flex-row space-x-0 space-y-2 sm:space-x-2 space- sm:space-y-0 justify-between items-stretch sm:items-center text-[{{ session()->get(Auth::user()->username . '-preference')['color_text'] }}] text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}]">
                ...
                <input wire:model="color_secondary" name="color_secondary" type="color" id="color_secondary" class="w-[5vw] h-[5vh] form-input text-center align-middle p-2 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{session()->get(Auth::user()->username . '-preference')['color_secondary']}}] @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
            </label>
            <label for="color_text" class="flex flex-col sm:flex-row space-x-0 space-y-2 sm:space-x-2 space- sm:space-y-0 justify-between items-stretch sm:items-center text-[{{ session()->get(Auth::user()->username . '-preference')['color_text'] }}] text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}]">
                ...
                <input wire:model="color_text" name="color_text" type="color" id="color_text" class="w-[5vw] h-[5vh] form-input text-center align-middle p-2 bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{session()->get(Auth::user()->username . '-preference')['color_secondary']}}] @error('cover') invalid @else valid @enderror rounded-lg cursor-pointer">
            </label>
            ...
            <div class="flex flex-col space-x-0 space-y-2 text-[{{ session()->get(Auth::user()->username . '-preference')['color_text'] }}] text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}]">
                ...
                <select wire:model="selected_font_family" name="selected_font_family" id="fonts" class="form-select bg-[{{ session()->get(Auth::user()->username . '-preference')['color_primary'] }}] border border-[{{ session()->get(Auth::user()->username . '-preference')['color_secondary'] }}] rounded-lg cursor-pointer">
    ...
    <button type="submit" wire:click="resetPreference" wire:confirm="Are you sure you want to reset your preference settings?" class="w-full h-fit p-2 text-center text-[{{ session()->get(Auth::user()->username . '-preference')['font_size'] .'px' }}] text-black bg-red-500 border-0 border-transparent rounded-lg cursor-pointer select-none transition-all duration-100 hover:opacity-50 active:duration-75 active:scale-[.95]">Reset Preference</button>
</div>