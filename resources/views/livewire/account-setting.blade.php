<div x-cloak x-show="account_modal"  class="w-full h-fit mb-2 p-2 flex flex-col space-x-0 space-y-2 bg-black border-0 border-transparent rounded-lg">
    ...
    @endif
    <form wire:submit="updateAccount" method="post" class="w-full h-fit p-0 bg-white border border-black rounded-lg">
        @csrf
        <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-2 justify-center">
            ...
            <button type="submit" class="w-full h-fit self-center p-2 text-base text-black bg-white border border-black rounded-lg">Update</button>
        </div>
    </form>
</div>