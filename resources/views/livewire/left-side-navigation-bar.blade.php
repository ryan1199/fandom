<div class="w-full max-w-sm h-screen max-h-[100vh] {{ 'text-[' . $preferences['font_size'] . 'px]' }} {{ 'leading-[calc(' . $preferences['font_size'] . 'px*1.2)]' }} {{ 'font-[' . $preferences['selected_font_family'] . ']' }} text-zinc-500 bg-zinc-100/95 border-r border-zinc-200 select-none overflow-y-auto">
    <div class="w-full h-fit p-2 flex flex-col space-x-0 space-y-1">
        @guest
            <a href="{{ route('home') }}" class="w-fit" draggable="false">Fandom</a>
            <a href="{{ route('login') }}" class="w-fit" draggable="false">Login</a>
            <a href="{{ route('register') }}" class="w-fit" draggable="false">Register</a>
            <a href="{{ route('fandom-list') }}" class="w-fit" draggable="false">Fandom list</a>
        @endguest
        @auth
            <a href="{{ route('home') }}" class="w-fit" draggable="false">Fandom</a>
            ...
            <div x-data="{ open_user: false }" class="flex flex-col space-x-0 space-y-1">
                <div class="flex flex-row justify-between items-center">
                    <a href="{{ route('user', $user) }}" class="w-fit" draggable="false">{{ $user->username }}</a>
                    ...
                    <svg x-cloak x-show="open_user" x-on:click="open_user = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                ...
                <div x-transition x-cloak x-show="open_user" class="pl-1 flex flex-col space-x-0 space-y-1">
                    <div x-data="{ open_followed_user_list: false }" class="flex flex-col space-x-0 space-y-1">
                        ...
                        <div class="flex flex-row justify-between items-center">
                            ...
                            <svg x-cloak x-show="open_followed_user_list" x-on:click="open_followed_user_list = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                                <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <hr class="border-zinc-200">
                        <div x-transition x-cloak x-show="open_followed_user_list">
                            @livewire(Follow::class, ['user' => $user, 'followed_users' => $followed_users, 'preferences' => $preferences])
                        </div>
                    </div>
                    <div x-data="{ open_blocked_user_list: false }" class="flex flex-col space-x-0 space-y-1">
                        <div class="flex flex-row justify-between items-center">
                            ...
                            <svg x-cloak x-show="open_blocked_user_list" x-on:click="open_blocked_user_list = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                                <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <hr class="border-zinc-200">
                        <div x-transition x-cloak x-show="open_blocked_user_list">
                            @livewire(Block::class, ['user' => $user, 'blocked_users' => $blocked_users, 'preferences' => $preferences])
                        </div>
                    </div>
                    <div x-data="{ open_setting: false }" class="flex flex-col space-x-0 space-y-1">
                        <div class="flex flex-row justify-between items-center">
                            ...
                            <svg x-cloak x-show="open_setting" x-on:click="open_setting = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                                <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <hr class="border-zinc-200">
                        <div x-transition x-cloak x-show="open_setting" class="pl-1 flex flex-col space-x-0 space-y-1">
                            ...
                            <div x-data="{ open_account_setting: false }" class="flex flex-col space-x-0 space-y-1">
                                <div class="flex flex-row justify-between items-center">
                                    ...
                                    <svg x-cloak x-show="open_account_setting" x-on:click="open_account_setting = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                                        <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <hr class="border-zinc-200">
                                <div x-transition x-cloak x-show="open_account_setting" class="flex flex-col space-x-0 space-y-1">
                                    @livewire(AccountSetting::class, ['user' => $user, 'preferences' => $preferences])
                                    <hr class="border-zinc-200">
                                </div>
                            </div>
                            {{-- profile --}}
                            <div x-data="{ open_profile_setting: false }" class="flex flex-col space-x-0 space-y-1">
                                <div class="flex flex-row justify-between items-center">
                                    ...
                                    <svg x-cloak x-show="open_profile_setting" x-on:click="open_profile_setting = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                                        <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <hr class="border-zinc-200">
                                <div x-transition x-cloak x-show="open_profile_setting" class="flex flex-col space-x-0 space-y-1">
                                    @livewire(ProfileSetting::class, ['user' => $user, 'preferences' => $preferences])
                                    <hr class="border-zinc-200">
                                </div>
                            </div>
                            {{-- preference --}}
                            <div x-data="{ open_preference_setting: false }" class="flex flex-col space-x-0 space-y-1">
                                <div class="flex flex-row justify-between items-center">
                                    ...
                                    <svg x-cloak x-show="open_preference_setting" x-on:click="open_preference_setting = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                                        <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                                    </svg>
                                </div>
                                <hr class="border-zinc-200">
                                <div x-transition x-cloak x-show="open_preference_setting" class="flex flex-col space-x-0 space-y-1">
                                    @livewire(PreferenceSetting::class, ['user' => $user, 'preferences' => $preferences])
                                    <hr class="border-zinc-200">
                                </div>
                            </div>
                        </div>
            ...
            <div x-data="{ open_fandom_list: false }" class="flex flex-col space-x-0 space-y-1">
                <div class="flex flex-row justify-between items-center">
                    ...
                    <svg x-cloak x-show="open_fandom_list" x-on:click="open_fandom_list = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                        <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                    </svg>
                </div>
                <hr class="border-zinc-200">
                <div x-transition x-cloak x-show="open_fandom_list" class="pl-1 flex flex-col space-x-0 space-y-1">
                    ...
                    <div x-data="{ open_create_fandom: false }" class="flex flex-col space-x-0 space-y-1">
                        <div class="flex flex-row justify-between items-center">
                            ...
                            <svg x-cloak x-show="open_create_fandom" x-on:click="open_create_fandom = false" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 {{ 'text-[' . $preferences['color_2'] . ']' }}">
                                <path fill-rule="evenodd" d="M11.47 7.72a.75.75 0 0 1 1.06 0l7.5 7.5a.75.75 0 1 1-1.06 1.06L12 9.31l-6.97 6.97a.75.75 0 0 1-1.06-1.06l7.5-7.5Z" clip-rule="evenodd" />
                            </svg>
                        </div>
                        <hr class="border-zinc-200">
                        <div x-transition x-cloak x-show="open_create_fandom" class="flex flex-col space-x-0 space-y-1">
                            {{-- create a fandom component --}}
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus a quae quaerat numquam, totam ab ea ullam itaque et atque libero. Laborum neque at, iure nobis eligendi blanditiis minima rem!</p>
                            <hr class="border-zinc-200">
                        </div>
                    </div>
                </div>
            </div>
            <a href="{{ route('post') }}" class="w-fit" draggable="false">Post</a>
            <hr class="border-zinc-200">
            <a href="{{ route('gallery') }}" class="w-fit" draggable="false">Gallery</a>
            <hr class="border-zinc-200">
